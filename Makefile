...
THE_CONQUEST.o: THE_CONQUEST.cpp Battle.h PrintChapLines.h Choice.h Chap1.h Chap2.h Fight.h load_game.h save_game.h Fortune_cookie.h
	g++ $(FLAGS) -c $<
...
Chap2: Battle.o PrintChapLines.o Choice.o Fight.o Chap2.o
	g++ $(FLAGS) $^ -o $@
Game: Chap1.o Chap2.o Fortune_cookie.o load_game.o save_game.o Battle.o PrintChapLines.o Choice.o Fight.o THE_CONQUEST.o 
	g++ $(FLAGS) $^ -o $@
