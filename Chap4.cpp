...
bool Chap4(string *Pname, int *Phitp, int *Phealth, int *Psol){//Funtion to implement chapter 4 of the game. It uses different functions from different cpp files and nested if-else statements to do so
  int *Lines = new int(6);
  ...
  cout<<"Will you:"<<endl<<"1.) Take a defensive stance."<<endl<<"2.) Step forward and try to disarm him."<<endl<<"3.) Kill him."<<endl<<"Enter 1, 2 or 3 based on your choice."<<endl;
  Choice(Choice1, ChoiceNum);//getting choice of the player
  if(*Choice1 == 1 || *Choice1 == 2){
    *Lines = 3;
    *ChapFiles = "Chapters/Chapter4c2.txt";
    PrintChapLines(ChapFiles, Lines);
    cout<<"Do you accept this offer?"<<endl<<"Enter 1 for yes or 2 for no."<<endl;
    *ChoiceNum = 2;
    Choice(Choice1, ChoiceNum);//getting choice of the player
    if(*Choice1 == 1){
      srand(time(NULL));
    ...
    cout<<"As he comes close to you, you swing your sword, but as you do so, you see that the man drops his sword, meaning that he isn't here to help you, but now it is too late to yourself and you hit him in his head."<<endl<<"He dies instantly"<<endl;
  }
  *Lines = 6;
